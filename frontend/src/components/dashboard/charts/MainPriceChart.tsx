    ...
    return (
        <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data} margin={{ top: 5, right: 5, left: 10, bottom: 15 }}>
                ...
                <XAxis 
                    dataKey="timestamp"
                    tickFormatter={(ts) => formatTimestamp(ts, effectiveTimeframe, selectedTimezone, customDateRange)}
                    type="number"
                ...
                <Tooltip 
                    ...
                    labelFormatter={(ts) => formatTimestamp(ts, effectiveTimeframe, selectedTimezone, customDateRange)}
